...
Rationale for including version 3.2.1:

* Regional regulations have adopted version 3.2.1, such as Europe, Canada, and Australia. TODO cite
* VPAT version 2.5 includes EN 301 549 version 3.2.1.

Rationale for including version 4.1.0 (2026-06):

* A contributor to EN 301 549 announced in June 2026 that this version is approved all but typos. TODO cite WCAG2ICT Task Force, June 2026 minutes

Rationale for the naming:

* This text is prominent in the title page of the source document.
* TODO find other official documents that cite these source documents by name
* We include the date because over time ETSI has posted more than one draft labeled "V4.1.0".

## Source document short names
...
* In context of accessibility knowledge, these identifiers are concise, unique, and human-readable enough.

Rationale for not including more version number details:
...
The source document's own numbering system is called "clauses". Rationale:

* Cross-references within the source document
* VPAT 2.5Rev release notes

Examples from version 4.1.0:

| Clause or Annex | Name 1 in the Source                                                          | Structure 1  | Name 2       | Structure 2          | Class    | Identifier | Name in the Model                                                             | Purpose for ASKM                        |
| --------------- | ----------------------------------------------------------------------------- | ------------ | ------------ | -------------------- | -------- | ---------- | ----------------------------------------------------------------------------- | --------------------------------------- |
| -               | -                                                                             | front matter | -            | page                 | fragment | _0.0.1     | Cover page                                                                    |                                         |
| -               | -                                                                             | front matter | -            | page                 | fragment | _0.0.2     | Second page                                                                   |                                         |
| -               | Intellectual Property Rights                                                  | h1           | -            | -                    | section  | _0.1       | Intellectual Property Rights                                                  |                                         |
| -               | Foreword                                                                      | h1           | -            | -                    | section  | _0.2       | Foreword                                                                      |                                         |
| -               | Modal verbs terminology                                                       | h1           | -            | -                    | section  | _0.3       | Modal verbs terminology                                                       |                                         |
| -               | Introduction                                                                  | h1           | -            | -                    | section  | _0.4       | Introduction                                                                  |                                         |
| -               | Introduction                                                                  | h1           | -            | p                    | fragment | _0.4.1     | (reserved)                                                                    |                                         |
| -               | Introduction                                                                  | h1           | -            | p                    | fragment | _0.4.2     | The present document covers...                                                | example of citing a source fragment     |
| -               | Introduction                                                                  | h1           | -            | p+list               | fragment | _0.4.3     | (reserved)                                                                    |                                         |
| -               | Introduction                                                                  | h1           | -            | p+list → p           | fragment | _0.4.3.0   | (reserved)                                                                    |                                         |
| -               | Introduction                                                                  | h1           | -            | p+list → item        | fragment | _0.4.3.1   | (reserved)                                                                    |                                         |
| -               | Introduction                                                                  | h1           | -            | p+list → item        | fragment | _0.4.3.5   | (reserved)                                                                    |                                         |
| -               | Introduction                                                                  | h1           | -            | p+list → item → p    | fragment | _0.4.3.5.0 | (reserved)                                                                    |                                         |
| -               | Introduction                                                                  | h1           | -            | p+list → item → item | fragment | _0.4.3.5.1 | Clause A.1 directs users...                                                   | example of citing a source fragment     |
...
| 4.2.1           | Usage without vision                                                          | h3           | Note 1       | block                | clause   | 4.2.1_1    | Note 1                                                                        |                                         |
| 9               | Web                                                                           | h1           | -            | -                    | clause   | 9          | Web                                                                           |                                         |
| 9.1             | Perceivable                                                                   | h2           | -            | -                    | clause   | 9.1        | Perceivable                                                                   |                                         |
| 9.1.4           | Distinguishable                                                               | h3           | -            | -                    | clause   | 9.1.4      | Distinguishable                                                               |                                         |
| 9.1.4.1         | Use of colour                                                                 | h4           | -            | -                    | clause   | 9.1.4.1    | Use of colour                                                                 | guideline                               |
| 9.1.4.6         | Void                                                                          | h4           | -            | -                    | clause   | 9.1.4.6    | Void                                                                          | void in the source                      |
| Annex B         | Relationship between requirements and functional performance criteria         | h1           | -            | -                    | annex    | B          | Relationship between requirements and functional performance criteria         |                                         |
| B.1             | Relationships between clauses 5 to 13 and the functional performance criteria | h2           | -            | -                    | annex    | B.1        | Relationships between clauses 5 to 13 and the functional performance criteria |                                         |
